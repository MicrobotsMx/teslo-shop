		...
		<form onSubmit={ handleSubmit(onSubmit) } className='grid grid-cols-1 gap-2 sm:gap-5 sm:grid-cols-2'>
			...
			<div className='flex flex-col mb-2 sm:mt-1'>
				...
				<div className='inline-flex items-center mb-10'>
					<label 
						className='relative flex cursor-pointer items-center rounded-full p-3 gap-2'
						htmlFor='checkbox'
					> 
						<input
							type='checkbox'
						...
						/>
						<div className='pointer-events-none absolute top-2/4 left-3.5 -translate-y-2/4 -translate-x text-white opacity-0 transition-opacity peer-checked:opacity-100'>
							<svg
